...
public class ChartLabelSettings {
    ...
    public init(font: UIFont = UIFont.systemFontOfSize(12), fontColor: UIColor = UIColor.blackColor(), rotation: CGFloat = 0, rotationKeep: ChartLabelDrawerRotationKeep = .Center, shiftXOnRotation: Bool = true) {
        self.font = font
